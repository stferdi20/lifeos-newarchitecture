  ...
  switch (state) {
    case 'online':
      return {
        ...
        icon: CheckCircle2,
        label: 'Running',
        summary: 'Instagram Downloader System is running',
      };
    case 'stale':
      return {
    ...
    default:
      return {
        ...
        icon: ServerCrash,
        label: 'Offline',
        summary: 'Instagram Downloader System is offline',
      };
  }
}
...
export default function InstagramDownloaderPanel() {
  ...
  const worker = statusQuery.data?.worker || { online: false, state: 'offline', label: 'Instagram Downloader', last_heartbeat_at: null };
