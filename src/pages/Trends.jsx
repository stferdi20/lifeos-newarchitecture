...
import { TrendingUp, RefreshCw, Cpu, Rocket, Bitcoin, Globe, Microscope } from 'lucide-react';
...
const categoryConfig = {
  ...
  ai_research: { icon: Microscope, color: 'text-cyan-300 bg-cyan-500/10 border-cyan-500/20' },
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Real-time trend aggregation across AI, AI research, tech, startups & crypto"
        className="mb-6"
        actions={(
          <button
            onClick={fetchTrends}
